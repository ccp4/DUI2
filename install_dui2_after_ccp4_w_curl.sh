...
CLIENT_EXE_CMD="ccp4-python $INI_DIR_PATH/DUI2-$TAG_VER/src/run_dui2_client.py \$@"
echo $EXPORT_CMD$'\n'$CLIENT_EXE_CMD > dui2_client_app
chmod +x dui2_client_app

SERVER_EXE_CMD="ccp4-python $INI_DIR_PATH/DUI2-$TAG_VER/src/run_dui2_server.py \$@"
echo $SERVER_EXE_CMD > dui2_server_side
chmod +x dui2_server_side

ALL_LOCAL_CMD="ccp4-python $INI_DIR_PATH/DUI2-$TAG_VER/src/run_dui2.py \$@"
