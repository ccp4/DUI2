...
class TwoThetaRefineSimplerParamTab(SimpleParamTab):
    """
    This widget is the tool for tuning the simpler and most common parameters
    in the two theta refiner, this widget is the first to appear once the button
    "Two Theta Refine" is clicked
    """
    def __init__(self, parent=None):
        super(TwoThetaRefineSimplerParamTab, self).__init__()
        self.do_emit = True
        self.main_v_layout = QVBoxLayout()
        self.build_pars()
        self.setLayout(self.main_v_layout)
...
class CosymSimplerParamTab(SimpleParamTab):
    """
    This widget is the tool for tuning the simpler and most common parameters
    in the cosym command, this widget is the first to appear once the button
    "Cosym" is clicked
    """
    def __init__(self, parent=None):
        super(CosymSimplerParamTab, self).__init__()
        self.do_emit = True
        self.main_v_layout = QVBoxLayout()
        self.build_pars()
        self.setLayout(self.main_v_layout)
...
class UploadDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        red_style = "color: rgba(250, 0, 0, 250)"

        url_layout = QHBoxLayout()
        url_layout.addWidget(QLabel("URL"))
        self.url_star = QLabel("*")
        self.url_star.setFont(star_font)
        self.url_star.setStyleSheet(red_style)
        ...
        user_layout.addWidget(QLabel("Login name"))
        self.user_star = QLabel("*")
        self.user_star.setFont(star_font)
        self.user_star.setStyleSheet(red_style)
        ...
        id_layout.addWidget(QLabel("CloudRun Id"))
        self.id_star = QLabel("*")
        self.id_star.setFont(star_font)
        self.id_star.setStyleSheet(red_style)
        ...
        project_layout.addWidget(QLabel("ID"))
        self.project_star = QLabel("*")
        self.project_star.setFont(star_font)
        self.project_star.setStyleSheet(red_style)
        ...
        title_layout.addWidget(QLabel("Project name "))
        name_space = QLabel(" ")
